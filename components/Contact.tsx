...
export default function Contact() {
  return (
    ...
    >
      <div className='absolute top-0 left-0 h-full w-full bg-[url("/assets/images/backgrounds/bg.png")] bg-contain bg-center bg-no-repeat opacity-100 mix-blend-multiply' />
