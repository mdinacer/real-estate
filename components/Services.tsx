    ...
    >
      <div className=" w-full py-16 px-10 ">
        ...
        <div className="mt-10 grid grid-flow-row grid-cols-1 gap-10 sm:grid-cols-2">
          <div className="">
            <div>
              <div className=" px-3 font-Raleway text-lg font-thin">
                <p className="pb-3 font-Oswald  text-3xl">
                  Renting, Purchasing, or Selling villas, shops and land.
                </p>
                <p className="pb-10">
                ...
                <p className="pb-3 font-Oswald  text-3xl">
                  Design and development and exploitation.
                </p>
                <p className="pb-10">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Impedit illo dolorum illum tempora rem soluta ducimus.
        ...
        <p className="mx-auto w-full max-w-2xl  text-center font-Cinzel text-base font-normal italic">
          ...
          dolorum illum tempora rem soluta ducimus. Molestiae sequi incidunt
          soluta.
        </p>
      </div>
    </div>
